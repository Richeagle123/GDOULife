    ...
    public static List<Map<String, String>> parseBooksItem(String htmlStr){
        ...
        try {
            ...
            for (int i = 0; i < units.size(); i++) {
                ...
                String bookInfo = book.split("著者")[1].split("出版社")[0];
                String bookInfo1 = book.split("出版社")[1].split("出版日期")[0];
                String bookInfo2 = book.split("出版日期")[1];
                ...
                map.put("bookInfo", String.format("著者%s",bookInfo));
                map.put("bookInfo1", String.format("出版社%s",bookInfo1));
                map.put("bookInfo2", String.format("出版日期%s",bookInfo2));
