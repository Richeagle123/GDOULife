 ...
 */
public class LibraryItemHomeFragment extends BaseFragment {
    ...
    public static LibraryItemHomeFragment newInstance(int position) {

        Bundle bundle = new Bundle();
        bundle.putInt("position", position);

        LibraryItemHomeFragment libraryItemHomeFragment = new LibraryItemHomeFragment();
        libraryItemHomeFragment.setArguments(bundle);
