 ...
 */
public class LibraryItemSearchFragment extends BaseFragment {
    ...
    public static LibraryItemSearchFragment newInstance(int position) {

        Bundle bundle = new Bundle();
        bundle.putInt("position", position);

        LibraryItemSearchFragment libraryItemSearchFragment = new LibraryItemSearchFragment();
        libraryItemSearchFragment.setArguments(bundle);
